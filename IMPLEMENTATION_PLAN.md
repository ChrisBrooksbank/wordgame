...
- [ ] Implement hex grid data model: axial coordinates (q,r), adjacency calculation, support for 4x4/5x5/5x8 grid sizes + unit tests (spec: 01-core-engine.md)
- [ ] Build word list compiler script: read ~280k word corpus, output DAWG/Trie binary to static/ (spec: 01-core-engine.md)
...
- [ ] Build Rush Mode game screen: 4x4 hex grid, 90-second countdown timer, live score display (spec: 03-rush-mode.md)
- [ ] Implement combo system: 1x-5x multiplier, resets after 3 seconds of inactivity, visual indicator (spec: 03-rush-mode.md)
...
- [ ] Build Memory Crucible mode: 4x4 hex, show tiles briefly (8s→2s decreasing), play from memory, 3-strike game over (spec: 05-remaining-modes.md)
